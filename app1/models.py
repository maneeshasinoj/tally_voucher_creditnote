...
class paymentvoucher(models.Model):
    ...
    particulars1=models.CharField(max_length=255,null=True)
    ...
    particulars2=models.CharField(max_length=255,null=True)
    curbalance2=models.CharField(max_length=25,null=True,blank=True)
    dr_cr2=models.CharField(max_length=10,null=True)
    amount2=models.CharField(max_length=25,null=True)
    particulars3=models.CharField(max_length=255,null=True)
    curbalance3=models.CharField(max_length=25,null=True)
    dr_cr3=models.CharField(max_length=10,null=True)
    amount3=models.CharField(max_length=25,null=True)
    particulars4=models.CharField(max_length=255,null=True)
    curbalance4=models.CharField(max_length=25,null=True)
    dr_cr4=models.CharField(max_length=10,null=True)
    amount4=models.CharField(max_length=25,null=True)
    particulars5=models.CharField(max_length=255,null=True)
    curbalance5=models.CharField(max_length=25,null=True)
    dr_cr5=models.CharField(max_length=10,null=True)
    amount5=models.CharField(max_length=25,null=True)
    particulars6=models.CharField(max_length=255,null=True)
    curbalance6=models.IntegerField(null=True)
    dr_cr6=models.CharField(max_length=10,null=True)
    amount6=models.IntegerField(null=True)
    particulars7=models.CharField(max_length=255,null=True)
    curbalance7=models.IntegerField(null=True)
    dr_cr7=models.CharField(max_length=10,null=True)
    amount7=models.IntegerField(null=True)
    particulars8=models.CharField(max_length=255,null=True)
    curbalance8=models.IntegerField(null=True)
    dr_cr8=models.CharField(max_length=10,null=True)
    amount8=models.IntegerField(null=True)
    vouchertype=models.CharField(max_length=255)
    voucherno=models.IntegerField()
    debitamount=models.IntegerField(null=True)
    creditamount=models.IntegerField(null=True)
...
class receiptvoucher(models.Model):
    ...
    amount1=models.IntegerField(null=True)
    particulars2=models.CharField(max_length=255,null=True)
    curbalance2=models.CharField(max_length=25,null=True,blank=True,default=None)
    dr_cr2=models.CharField(max_length=10,null=True)
    amount2=models.CharField(max_length=25,null=True)
    particulars3=models.CharField(max_length=255,null=True)
    curbalance3=models.CharField(max_length=25,null=True)
